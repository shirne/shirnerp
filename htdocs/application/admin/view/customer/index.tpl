...
<div id="page-wrapper">
    <div class="row list-header">
        <div class="col-md-6">
            <a href="{:url('customer/add')}" class="btn btn-outline-primary btn-sm"><i class="ion-md-add"></i> 添加客户</a>
        </div>
        <div class="col-md-6">
    ...
    <table class="table table-hover table-striped">
        ...
        <foreach name="lists" item="v">
            <tr>
                ...
                <td class="operations">
                    <a class="btn btn-outline-primary" title="编辑" href="{:url('customer/update',array('id'=>$v['id']))}"><i class="ion-md-create"></i> </a>
