...
VALUES
  ...
  (5,0,'生产','','Produce','ion-md-git-network',1,0),
  (6,0,'财务','','Finance','ion-md-calculator',1,0),
  ...
  (32,3,'采购单管理','PurchaseOrder/index','purchase_order_index','ion-md-paper',0,0),
  (33,3,'采购单统计','PurchaseOrder/statics','purchase_order_statics','ion-md-stats',0,0),
  (41,4,'客户管理','Customer/index','customer_index','ion-md-contacts',0,0),
  (42,4,'销售单管理','SaleOrder/index','sale_order_index','ion-md-paper',0,0),
  (43,4,'销售单统计','SaleOrder/statics','sale_order_statics','ion-md-stats',0,0),
  (51,5,'生产流程','Produce/index','produce_index','ion-md-git-merge',0,0),
  (52,5,'生产单','ProduceOrder/index','produce_order','ion-md-paper',0,0),
  (53,5,'生产统计','ProduceOrder/statics','produce_order_statics','ion-md-stats',0,0),
  (60,6,'财务总览','Finance/index','finance_index','ion-md-easel',0,0),
  (61,6,'应收款','Finance/receive','finance_receive','ion-md-arrow-round-forward',0,0),
  (62,6,'应付款','Finance/payable','finance_payable','ion-md-arrow-round-back',0,0),
  (63,6,'收支明细','Finance/logs','finance_logs','ion-md-paper',0,0),
...
VALUES
  ('site-webname','站点名','text','common',0,1,'ShirnERP','站点名',''),
